...
;// CONCATENATED MODULE: ./models/Faq.js

const FaqSchema = new external_mongoose_.Schema({
    oneTitle: {
        type: String
    },
    oneSupTitle: {
...
const Faq = external_mongoose_.models?.Faq || (0,external_mongoose_.model)("Faq", FaqSchema);
...
async function handle(req, res) {
    ...
    if (method === "PUT") {
        const { oneTitle , oneSupTitle , twoTitle , twoSupTitle , threeTitle , threeSupTitle  } = req.body;
        await Faq.updateOne({
            oneTitle,
            oneSupTitle,
            twoTitle,
