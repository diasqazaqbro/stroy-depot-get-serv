...
;// CONCATENATED MODULE: ./models/Welcome.js

const WelcomeSchema = new external_mongoose_.Schema({
    welcomeTitle: {
        type: String
    },
    welcomeSupTitle: {
...
const Welcome = external_mongoose_.models?.Welcome || (0,external_mongoose_.model)("Welcome", WelcomeSchema);

;// CONCATENATED MODULE: ./pages/api/welcome.js
