...
;// CONCATENATED MODULE: ./models/Price.js

const PriceSchema = new external_mongoose_.Schema({
    oneTitle: {
        type: String
    },
    oneSupTitle: {
...
const Price = external_mongoose_.models?.Price || (0,external_mongoose_.model)("Price", PriceSchema);

;// CONCATENATED MODULE: ./pages/api/price.js
